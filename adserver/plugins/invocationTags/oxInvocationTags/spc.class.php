...
<head>
    ...
    <body class='invocationCodes'>
        ...
        <div class='settings'>
            ...
            <p>
                " . $GLOBALS['strGenCodeAdInfo'] . "
            </p>

            <h3>" . $GLOBALS['strGenCodeFollowingSettings'] . "</h3>
        ...
        foreach ($this->defaultOptionValues as $feature => $default) {
            switch ($feature) {
                ...
                case 'target':
                    ...
                    switch ($mi->$feature) {
                        case '_blank':
                            $optionValue = 'New window';
                            break;
                        case '_top':
                            $optionValue = 'Same window';
                            break;
                        default:
                            $optionValue = $GLOBALS['strDefault'];
                            break;
                    }
                    break;
                case 'source':
        ...
        <div class='step'>
            ...
            <p>
                " . $GLOBALS['strGenCodeHeaderStart'] . htmlspecialchars($affiliate['website']) . $GLOBALS['strGenCodeHeaderEnd'] . "
            </p>
        ...
        <div class='step'>
            ...
            <p>
                " . $GLOBALS['strGenCodeCopyNote'] . "
            </p>

            <pre>" . htmlspecialchars($codeblock) . "</pre>

            <p>
                " . $GLOBALS['strGenCodeExample'] . ($zone['width'] == -1 || $zone['height'] == -1 ? ' (actual size may vary)' : '') . ":
            </p>
        ...
        <div class='step'>
            ...
            <p>
                " . $GLOBALS['strGenCodeDone'] . "
            </p>

            <button id='closeWindow'><img src='" . OX::assetPath() . "/images/cross.png' alt='' />" . $GLOBALS['strGenCodeCloseWindow'] . "</button>
        </div>
    ...
    function getHeaderCode($aZoneAliases = null)
    {
        ...
        foreach ($this->defaultOptionValues as $feature => $default) {
            ...
            if ($feature == 'source' || $feature == 'noscript' || $feature == 'ssl') {
                continue;
            }

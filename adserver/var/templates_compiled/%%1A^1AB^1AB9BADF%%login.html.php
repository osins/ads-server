<?php /* Smarty version 2.6.18, created on 2022-04-08 02:54:59
         compiled from login.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'login.html', 13, false),array('function', 't', 'login.html', 21, false),array('function', 'tabindex', 'login.html', 55, false),array('function', 'phpAds_ShowBreak', 'login.html', 101, false),)), $this); ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['appName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <div class="errormessage" style="width: 400px">
          <img
            class="errormessage"
            src="<?php echo ((is_array($_tmp=$this->_tpl_vars['assetPath'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/images/errormessage.gif"
            align="absmiddle"
          />
...
<?php else: ?> <?php echo OA_Admin_Template::_function_phpAds_ShowBreak(array(), $this);?>

<br /><img
  src="<?php echo ((is_array($_tmp=$this->_tpl_vars['assetPath'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/images/info.gif"
  align="absmiddle"
/>&nbsp;<?php echo OA_Admin_Template::_function_t(array('str' => 'NoAdminInterface'), $this);?>
 <?php endif; ?> <!-- login -->
<?php /* Smarty version 2.6.18, created on 2022-04-06 17:57:50
         compiled from campaign-index-list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'campaign-index-list.html', 22, false),array('function', 'rv_add_session_token', 'campaign-index-list.html', 57, false),array('function', 'ox_column_class', 'campaign-index-list.html', 116, false),array('function', 'ox_column_title', 'campaign-index-list.html', 117, false),array('function', 'cycle', 'campaign-index-list.html', 167, false),array('function', 'ox_campaign_icon', 'campaign-index-list.html', 178, false),array('function', 'ox_entity_id', 'campaign-index-list.html', 187, false),array('function', 'ox_campaign_status', 'campaign-index-list.html', 190, false),array('function', 'ox_campaign_type', 'campaign-index-list.html', 193, false),array('function', 'ox_column_updated', 'campaign-index-list.html', 194, false),array('modifier', 'count', 'campaign-index-list.html', 137, false),array('modifier', 'escape', 'campaign-index-list.html', 179, false),)), $this); ?>
  ...
  <div class="tableHeader">
    <ul class="tableActions">
      ...
      <li>
        ...
        <a
          href="campaign-edit.php?clientid=<?php echo $this->_tpl_vars['clientId']; ?>
"
          class="inlineIcon iconCampaignAdd"
          ><?php echo OA_Admin_Template::_function_t(array('str' => 'AddCampaign'), $this);?>
</a
        >
        <?php else: ?>
        <span class="inlineIcon iconCampaignAddDisabled"
          ><?php echo OA_Admin_Template::_function_t(array('str' => 'AddCampaign'), $this);?>
</span
        >
        <?php endif; ?>
...
<?php echo '&campaignid=" +
    ...
    <ul class="tableFilters alignRight">
      <li>
        ...
        <div class="dropDown">
          <span
            ><span><?php if ($this->_tpl_vars['hideinactive']): ?>激活的活动<?php else: ?>全部活动<?php endif; ?></span></span
          >
          ...
          <div class="panel">
            <div>
              <ul>
                <li>
                  <a
                    href="advertiser-campaigns.php?clientid=<?php echo $this->_tpl_vars['clientId']; ?>
&hideinactive=0"
                    >全部活动</a
                  >
                </li>
      ...
      <tr class="even">
        <td colspan="6" class="hasPanel">
          <div class="tableMessage">
            <div class="panel">
              <?php if ($this->_tpl_vars['clientId'] != -1): ?> <?php if ($this->_tpl_vars['hideinactive']): ?> <?php echo $this->_tpl_vars['aCount']['campaigns_hidden']; ?>

              <?php echo OA_Admin_Template::_function_t(array('str' => 'InactiveCampaignsHidden'), $this);?>
 <?php else: ?> <?php echo OA_Admin_Template::_function_t(array('str' => 'NoCampaigns'), $this);?>
 <?php endif; ?>
              <?php else: ?> <?php echo OA_Admin_Template::_function_t(array('str' => 'NoCampaignsAddAdvertiser'), $this);?>
 <?php endif; ?>
...
"
          ...
          >
          <?php endif; ?> <?php echo OA_Admin_Template::_function_ox_entity_id(array('type' => 'Campaign','id' => $this->_tpl_vars['campaignId']), $this);?>
        ...
        <td><?php echo OA_Admin_Template::_function_ox_campaign_type(array('type' => $this->_tpl_vars['campaign']['type']), $this);?>
</td>
        <td><?php echo OA_Admin_Template::_function_ox_column_updated(array('updated' => $this->_tpl_vars['campaign']['updated']), $this);?>
</td>
...
&campaignid=<?php echo $this->_tpl_vars['campaignId']; ?>
"
                class="inlineIcon iconBanners"
                ><?php echo OA_Admin_Template::_function_t(array('str' => 'Banners'), $this);?>
</a
              >
            </li>
          </ul>
          ...
          <div class="panel">
            <table cellspacing="0" summary="">
              <tr>
                ...
                <td>
                  <?php if ($this->_tpl_vars['campaign']['impressions'] >= 0): ?><?php echo $this->_tpl_vars['campaign']['impressions']; ?>
...
<?php endif; ?>
              ...
              <tr>
                ...
                <td>
                  <?php if ($this->_tpl_vars['campaign']['clicks'] >= 0): ?><?php echo $this->_tpl_vars['campaign']['clicks']; ?>
<?php else: ?><?php echo OA_Admin_Template::_function_t(array('str' => 'Unlimited'), $this);?>
<?php endif; ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <?php if ($this->_tpl_vars['campaign']['conversions'] >= 0): ?><?php echo $this->_tpl_vars['campaign']['conversions']; ?>
<?php else: ?><?php echo OA_Admin_Template::_function_t(array('str' => 'Unlimited'), $this);?>
<?php endif; ?>
                </td>
              </tr>

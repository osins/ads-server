...
$GLOBALS['strLastLoggedIn'] = "最后一次登录";
...
// Advertiser
$GLOBALS['strClient'] = "账户";
$GLOBALS['strClients'] = "账户";
...
$GLOBALS['strOverrideInfo'] = "覆盖广告系列是一种特殊的广告系列类型，专门用于覆盖（即优先于）剩余和合同广告系列。 
覆盖活动通常与特定目标和/或上限规则一起使用，以确保活动横幅始终显示在特定位置、特定用户，
并且可能显示特定次数，作为特定促销的一部分。 （此广告系列类型以前称为“合同（独家）”。）";
$GLOBALS['strStandardContractInfo'] = "合同活动是为了顺利传达印象，需要达到规定的时间关键性能要求。也就是说，合同活动是为了什么时候
，一个广告商专门为获得一定数量的印象、点击和/或转化而付费在两个日期之间或每天实现。";
$GLOBALS['strRemnantInfo'] = "默认的活动类型。残余运动有很多不同的特点交付选项，理想情况下，
您应该始终至少有一个残余活动链接到每个区域，以确保总是有东西可以展示。使用剩余活动来显示房屋横幅、广告网络横幅，
甚至已售出的直接广告，但该广告没有时间要求要坚持的运动。";
...
$GLOBALS['strDefaultStatus'] = "默认确认状态";
...
$GLOBALS['strBannerHistory'] = "Banner 统计";
...
$GLOBALS['strBannerCreative'] = "横幅广告素材";
$GLOBALS['strURLBanner'] = "链接到外部Banner";
$GLOBALS['strHTMLBanner'] = "创建HTML Banner";
$GLOBALS['strBannerLink'] = "素材链接";
$GLOBALS['strBannerDisplay'] = "显示设置";
$GLOBALS['strAdditionalData'] = "其他设置";
...
$GLOBALS['strACL'] = "投放控制";
$GLOBALS['strApplyLimitationsTo'] = "应用投递规则去";
$GLOBALS['strAllBannersInCampaign'] = "该项目下的所有素材";
$GLOBALS['strRemoveAllLimitations'] = "删除全部投放规则";
...
$GLOBALS['strOS'] = "操作系统";
$GLOBALS['strIsAnyVersionOf'] = "任意版本";

$GLOBALS['strEqualTo'] = "等于";
$GLOBALS['strDifferentFrom'] = "不等于";
...
$GLOBALS['strLessThan'] = "小于";
$GLOBALS['strGreaterOrEqualTo'] = "大于或等于";
$GLOBALS['strLessOrEqualTo'] = "小于或等于";
$GLOBALS['strAND'] = "和";                          // logical operator
$GLOBALS['strOR'] = "或";                         // logical operator
$GLOBALS['strOnlyDisplayWhen'] = "仅在以下情况下显示此横幅:";
...
$GLOBALS['strBrowser'] = "浏览器";
$GLOBALS['strOS'] = "操作系统";
$GLOBALS['strDeliveryLimitations'] = "投递规则";

$GLOBALS['strIsAnyOf'] = "是";
$GLOBALS['strIsNotAnyOf'] = "不是";

$GLOBALS['strACLAdd'] = "添加投放规则";
$GLOBALS['strDeliveryLimitations'] = "投递规则";
$GLOBALS['strNoLimitations'] = "暂无投放规则";
...
$GLOBALS['strCappingBanner']['title'] = "每位访客的投放规则";
$GLOBALS['strCappingBanner']['limit'] = "限制展示";

if (!isset($GLOBALS['strCappingCampaign'])) {
    $GLOBALS['strCappingCampaign'] = array();
}
$GLOBALS['strCappingCampaign']['title'] = "每位访客的投放规则";
$GLOBALS['strCappingCampaign']['limit'] = "限制展示";

if (!isset($GLOBALS['strCappingZone'])) {
    $GLOBALS['strCappingZone'] = array();
}
$GLOBALS['strCappingZone']['title'] = "每位访客的投放规则";
...
$GLOBALS['strAffiliateHistory'] = "媒体统计";
...
$GLOBALS['strReportMore'] = "此报告按日期、活动和区域显示特定广告商或网站的广告明细。";
...
$GLOBALS['strGenCodeAdInfo'] = "此页面包含在您的网站上显示横幅所需的所有信息。 请仔细按照说明进行操作，并确保您完全按照如下所示复制了脚本。";
$GLOBALS['strGenCodeFollowingSettings'] = "当前投放设置:";
$GLOBALS['strGenCodeHeaderStart'] = "在 <strong>";
$GLOBALS['strGenCodeHeaderEnd'] = " </strong> 网站的每个页面的顶部插入以下脚本, 此代码应位于 <code>&lt;head&gt;</code> 和 <code>&lt;/head&gt;</code> 标记之间, 位于页面上的任何广告脚本之前: ";
$GLOBALS['strGenCodeCopyNote'] = "复制以下脚本并将其放置在您希望展示广告的网站页面中: ";
$GLOBALS['strGenCodeExample'] = "示例";
$GLOBALS['strGenCodeDone'] = "广告内容现在应该会出现在您的网站上";
$GLOBALS['strGenCodeCloseWindow'] = "关闭窗口";

// Home Grid
$GLOBALS['strWidgetsMemo'] = "将小部件从此处拖到主区域";

$GLOBALS['strMoreWidgetsLabel'] = "更多小部件";
$GLOBALS['strCloseWidgetsLabel'] = "关闭小部件";

$GLOBALS['strDashboardYourStatisticsLabel'] = "统计";
$GLOBALS['strDashboardAuditTrailLabel'] = "日志";
$GLOBALS['strDashboardCampaignOverviewLabel'] = "事件";
...
// Agency
$GLOBALS['strAgencyManagement'] = "账户";
$GLOBALS['strAgency'] = "账户";
$GLOBALS['strAddAgency'] = "添加新的账户";
$GLOBALS['strAddAgency_Key'] = "添加新的账户";
$GLOBALS['strTotalAgencies'] = "账户数";
$GLOBALS['strAgencyProperties'] = "账户";
$GLOBALS['strNoAgencies'] = "您还没有添加账户";
$GLOBALS['strConfirmDeleteAgency'] = "您真的要删除该账户吗？";
$GLOBALS['strHideInactiveAgencies'] = "隐藏停用的账户";
$GLOBALS['strInactiveAgenciesHidden'] = "个账户已被隐藏";
...
$GLOBALS['strChannelManagement'] = "投放规则";
$GLOBALS['strAddNewChannel'] = "新增投放规则";
$GLOBALS['strAddNewChannel_Key'] = "新增投放规则";
...
$GLOBALS['strChannels'] = "规则";
$GLOBALS['strNoChannels'] = "暂无投放规则.";

// Tracker Variables
$GLOBALS['strTrackerPreferences'] = "事件跟踪";

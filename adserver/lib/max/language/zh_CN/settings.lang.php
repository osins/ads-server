...
$GLOBALS['strEnableECPM'] = "使用 eCPM 优化的优先级而不是剩余加权优先级";
$GLOBALS['strEnableECPMfromRemnant'] = "（如果您启用此功能，您的所有剩余广告系列都将被停用，您必须手动更新它们才能重新激活它们）";
$GLOBALS['strEnableContractECPM'] = "使用 eCPM 优化优先级而不是标准合同优先级";
...
$GLOBALS['strDefaultTrackerType'] = "默认跟踪类型";
...
$GLOBALS['strIsEqualTo'] = "等于";
$GLOBALS['strIsDifferent from'] = "不等于";
$GLOBALS['strIsLessThan'] = "小于";
$GLOBALS['strIsGreaterThan'] = "大于";
$GLOBALS['strIsLessOrEqualTo'] = "小于等于";
$GLOBALS['strIsGreaterOrEqualTo'] = "大于等于";

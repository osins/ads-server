...
$GLOBALS['strAuthentification'] = "权限验证";
$GLOBALS['strWelcomeTo'] = "欢迎您访问";
$GLOBALS['strEnterUsername'] = "请输入您的账号和密码";
...
$GLOBALS['strAllowCreateAccounts'] = "管理用户";
...
$GLOBALS['strBannerCreative'] = "banner creative";
$GLOBALS['strBannerLink'] = "Banner link";
$GLOBALS['strBannerDisplay'] = "Banner display";
$GLOBALS['strAdditionalData'] = "Additional data";
...
$GLOBALS['strReportMore'] = "This report shows a breakdown of advertising for a particular advertiser or website, by day, campaign, and zone.";
...
$GLOBALS['strSSLDeliveryComment'] = "
  ...
  *   'https://%s/...'
  *";
$GLOBALS['strGenCodeAdInfo'] = "This page contains all the information you need to show banners on your website.
                Please follow the instructions carefully and ensure that you copied the scripts <strong>exactly</strong> as shown below.";
$GLOBALS['strGenCodeFollowingSettings'] = "The following settings were used to generate this page:";
$GLOBALS['strGenCodeHeaderStart'] = "Insert the following script at the top of every page on the <strong>";
$GLOBALS['strGenCodeHeaderEnd'] = "</strong> website. This code belongs between the <code>&lt;head&gt;</code> and <code>&lt;/head&gt;</code> tags, before any ad scripts on the page:";
$GLOBALS['strGenCodeCopyNote'] = "Copy the following script and place it in the site where you want the ad to display:";
$GLOBALS['strGenCodeExample'] = "Example";
$GLOBALS['strGenCodeDone'] = "Banners should now appear on your website";
$GLOBALS['strGenCodeCloseWindow'] = "Close this window";

// Home Grid
$GLOBALS['strWidgetsMemo'] = "Drag widgets from here to the main area";
$GLOBALS['strMoreWidgetsLabel'] = "More widgets";
$GLOBALS['strCloseWidgetsLabel'] = "Close widgets";

$GLOBALS['strDashboardYourStatisticsLabel'] = "Your Statistics";
$GLOBALS['strDashboardAuditTrailLabel'] = "Audit Trail";
$GLOBALS['strDashboardCampaignOverviewLabel'] = "Campaign Overview";
...
$GLOBALS['strXRequiredField'] = "is required";
$GLOBALS['strRequiredField'] = "%s is required";
...
$GLOBALS['strAddNewChannel_Key'] = "Add new Delivery Rule Set";
...
$GLOBALS['strForgotPassword'] = "忘记密码了?";

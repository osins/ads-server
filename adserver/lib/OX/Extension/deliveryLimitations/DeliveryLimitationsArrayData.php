...
class Plugins_DeliveryLimitations_ArrayData extends Plugins_DeliveryLimitations
{
    ...
    function __construct()
    {
        ...
        $this->aOperations = array(
            '=~' => MAX_Plugin_Translation::translate($GLOBALS['strIsAnyOf'], $this->extension, $this->group),
            '!~' => MAX_Plugin_Translation::translate($GLOBALS['strIsNotAnyOf'], $this->extension, $this->group)
        );
    }

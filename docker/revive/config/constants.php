    ...
    if (!(isset($GLOBALS['_MAX']['CONF']))) {
        ...
        if (!empty($GLOBALS['_MAX']['CONF']['openads']['requireSSL'])) {
            ...
            if (isset($_SERVER['SERVER_PORT'])) {
                if (
                    isset($GLOBALS['_MAX']['CONF']['openads']['sslPort']) &&
        ...
        // Set the dbms type
        if (
            isset($GLOBALS['_MAX']['CONF']['database'])
